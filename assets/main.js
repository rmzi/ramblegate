...
// Initialize Input State to `home`
var INPUT_STATE = "HOME";
...
var keyHandler = function (event) {
  // TODO: switch ifs to switch statement
  // HOME MODE
  if (INPUT_STATE === "HOME") {
  ...
  // TITLE MODE
  if (INPUT_STATE === "TITLE") {
    if (event.key == "Enter") {
      title.hide();

      // Change INPUT_STATE to board
      INPUT_STATE = "BOARD";
